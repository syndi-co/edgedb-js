...
exports.parseHumanDurationString = exports.DateDuration = exports.RelativeDuration = exports.Duration = exports.LocalDateTime = exports.LocalDateFromOrdinal = exports.LocalDateToOrdinal = exports.LocalDate = exports.localDateInstances = exports.LocalTime = exports.localTimeInstances = exports.DATE_PRIVATE = void 0;
    ...
    toString() {
        ...
        if ((!dateParts && !timeParts) ||
            ...
            const totalNanoseconds = bi
                .add(bi.add(bi.add(bi.mul(bi.make(Math.abs(this.seconds)), bi.make(1e9)), bi.mul(bi.make(Math.abs(this.milliseconds)), bi.make(1e6))), bi.mul(bi.make(Math.abs(this.microseconds)), bi.make(1e3))), bi.make(Math.abs(this.nanoseconds)))
                .toString()
                .padStart(10, "0");
